...
// 질문댓글 목록을 조회하는 API
function toggleLikeQuestionApi(userId, questionId) {
  return instance.put(`like/question/${userId}/${questionId}`);
}

function toggleLikeAnswerApi(userId, answerId) {
  return instance.put(`like/answer/${userId}/${answerId}`);
}

function getLikeQuestionApi(userId, questionId) {
  return instance.get(`like/question/${userId}/${questionId}`);
}

function getLikeAnswerApi(userId, questionId) {
  return instance.get(`like/answer/${userId}/${questionId}`);
}
